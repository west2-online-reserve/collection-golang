...
// // 获取子评论（使用新版API）
// // ---------------------
// func fetchChildReplies(root int64, pn int) ([]Reply, bool, error) {
// 	// 每页获取10条子评论，避免一次请求太多
// 	url := fmt.Sprintf(
// 		"https://api.bilibili.com/x/v2/reply/reply?jsonp=jsonp&type=1&oid=%d&root=%d&pn=%d&ps=10",
// 		oid, root, pn,
...
// 	if resp.Code != 0 {
// 		log.Printf("子评论API返回错误: %d, %s", resp.Code, resp.Message)
// 		return nil, false, fmt.Errorf("API错误: %s", resp.Message)
// 	}

// 	return resp.Data.Replies, resp.Data.Cursor.IsEnd, nil
// }

// // 获取ID为int64（统一处理）
// func (r *Reply) GetRpid() int64 {
// 	return interfaceToInt64(r.Rpid)
// }

// func (r *Reply) GetMid() int64 {
// 	return interfaceToInt64(r.Mid)
// }

// func (m *Member) GetMid() int64 {
// 	return interfaceToInt64(m.Mid)
// }
