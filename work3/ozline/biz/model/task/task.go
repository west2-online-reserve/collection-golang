...
type TaskService interface {
	...
	QueryTaskListByStatus(ctx context.Context, req *QueryTaskListByStatusRequest) (r *QueryTaskListByStatusResponse, err error)
...
func (p *TaskServiceClient) QueryTaskListByStatus(ctx context.Context, req *QueryTaskListByStatusRequest) (r *QueryTaskListByStatusResponse, err error) {
	var _args TaskServiceQueryTaskListByStatusArgs
	_args.Req = req
	var _result TaskServiceQueryTaskListByStatusResult
	if err = p.Client_().Call(ctx, "QueryTaskListByStatus", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func NewTaskServiceProcessor(handler TaskService) *TaskServiceProcessor {
	...
	self.AddToProcessorMap("QueryTaskListByStatus", &taskServiceProcessorQueryTaskListByStatus{handler: handler})
...
type taskServiceProcessorQueryTaskListByStatus struct {
	handler TaskService
}

func (p *taskServiceProcessorQueryTaskListByStatus) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := TaskServiceQueryTaskListByStatusArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("QueryTaskListByStatus", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := TaskServiceQueryTaskListByStatusResult{}
	var retval *QueryTaskListByStatusResponse
	if retval, err2 = p.handler.QueryTaskListByStatus(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing QueryTaskListByStatus: "+err2.Error())
		oprot.WriteMessageBegin("QueryTaskListByStatus", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("QueryTaskListByStatus", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type TaskServiceQueryTaskListByStatusArgs struct {
	Req *QueryTaskListByStatusRequest `thrift:"req,1"`
}

func NewTaskServiceQueryTaskListByStatusArgs() *TaskServiceQueryTaskListByStatusArgs {
	return &TaskServiceQueryTaskListByStatusArgs{}
}

var TaskServiceQueryTaskListByStatusArgs_Req_DEFAULT *QueryTaskListByStatusRequest

func (p *TaskServiceQueryTaskListByStatusArgs) GetReq() (v *QueryTaskListByStatusRequest) {
	if !p.IsSetReq() {
		return TaskServiceQueryTaskListByStatusArgs_Req_DEFAULT
	}
	return p.Req
}

var fieldIDToName_TaskServiceQueryTaskListByStatusArgs = map[int16]string{
	1: "req",
}

func (p *TaskServiceQueryTaskListByStatusArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *TaskServiceQueryTaskListByStatusArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_TaskServiceQueryTaskListByStatusArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *TaskServiceQueryTaskListByStatusArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *TaskServiceQueryTaskListByStatusArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("QueryTaskListByStatus_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *TaskServiceQueryTaskListByStatusArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *TaskServiceQueryTaskListByStatusArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("TaskServiceQueryTaskListByStatusArgs(%+v)", *p)
}

type TaskServiceQueryTaskListByStatusResult struct {
	Success *QueryTaskListByStatusResponse `thrift:"success,0,optional"`
}

func NewTaskServiceQueryTaskListByStatusResult() *TaskServiceQueryTaskListByStatusResult {
	return &TaskServiceQueryTaskListByStatusResult{}
}

var TaskServiceQueryTaskListByStatusResult_Success_DEFAULT *QueryTaskListByStatusResponse

func (p *TaskServiceQueryTaskListByStatusResult) GetSuccess() (v *QueryTaskListByStatusResponse) {
	if !p.IsSetSuccess() {
		return TaskServiceQueryTaskListByStatusResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_TaskServiceQueryTaskListByStatusResult = map[int16]string{
	0: "success",
}

func (p *TaskServiceQueryTaskListByStatusResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *TaskServiceQueryTaskListByStatusResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_TaskServiceQueryTaskListByStatusResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *TaskServiceQueryTaskListByStatusResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *TaskServiceQueryTaskListByStatusResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("QueryTaskListByStatus_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *TaskServiceQueryTaskListByStatusResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *TaskServiceQueryTaskListByStatusResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("TaskServiceQueryTaskListByStatusResult(%+v)", *p)
}
