...
import (
	...
	task "github.com/west2-online-reserve/collection-golang/work3/biz/model/task"
...
// DeleteTaskByStatus .
// @router /task/deleteByStatus [DELETE]
...
// @router /task/queryListByStatus [GET]
func QueryTaskListByStatus(ctx context.Context, c *app.RequestContext) {
	var err error
...
// @router /task/queryListByKeyword [GET]
